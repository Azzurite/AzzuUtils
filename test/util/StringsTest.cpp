...
TEST_F(StringsTest, Join_CanJoinOneString)
{
	ASSERT_EQ(string("1"), join(",", {"1"}));
}

TEST_F(StringsTest, ToStringJoin_CanJoinNumbers)
{
	ASSERT_EQ(string("1,2,3"), toStringJoin(",", 1, 2, 3));
}

TEST_F(StringsTest, ToStringJoin_CanJoinOneNumber)
{
	ASSERT_EQ(string("1"), toStringJoin(",", 1));
}

TEST_F(StringsTest, ToStringJoin_CanJoinNumbers_WhenNumberTypesDiffer)
{
